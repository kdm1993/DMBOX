...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "S6G1FEe39f_eEOMNA58_";  
	private final static String CLIENT_SECRET = "tfFbyN5NS0"; 
	private final static String REDIRECT_URI = "http://dmcafe.co.kr/callback";
