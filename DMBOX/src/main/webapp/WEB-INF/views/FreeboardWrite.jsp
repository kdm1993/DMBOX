...
<body>
	...
	<div id="FreeboardWrite" class="container">
		<form action="FreeboardWriteSend" method="POST" accept-charset="UTF-8" id="freeboard_form">
			<div>
				<label style="font-weight: bold; margin:1%;">제목</label>
				<input type="text" id="title" name="title" style="border:1px solid #CCCCCC; width:90%;" placeholder="게시글 제목을 입력하세요" required>		
			</div>
			<div>
