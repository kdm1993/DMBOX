			...
			<div class="form-group" id="divAddress">
				...
				<div class="col-lg-10">
					<div class="div_left" style="margin-bottom:5px;">
						<input type="text" class="form-control" name="wPostCode" id="postcode" placeholder="우편번호" readonly="readonly">
	                    <input type="button" value="우편번호 찾기" style="width:120px;" onclick='execDaumPostcode();'>					
					</div>
					<div class="div_left" style="margin-bottom:5px;">    
	                    <input type="text" class="form-control" name="wRoadAddress" id="roadAddress" placeholder="도로명주소" readonly="readonly">
	                    <input type="text" class="form-control" name="wJibunAddress" id="jibunAddress" placeholder="지번주소" readonly="readonly">					
					</div>  
					<div class="div_left">
	                    <input type="text" class="form-control" name="wRestAddress" id="otheraddr" placeholder="나머지 주소"/>
					</div>
				</div>
			</div>
			...
			function execDaumPostcode() {
		        new daum.Postcode({
		            oncomplete: function(data) {
		                ...
		                document.getElementById('otheraddr').focus();
		            }
		        }).open();
		    }
